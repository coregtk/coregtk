...
-(id)init
{
	self = [super initWithGtkWidget:gtk_check_menu_item_new ()];
...
{
	self = [super initWithGtkWidget:gtk_check_menu_item_new_with_label ([label UTF8String])];
...
{
	self = [super initWithGtkWidget:gtk_check_menu_item_new_with_mnemonic ([label UTF8String])];
