...
-(id)init
{
	self = [super initWithGtkWidget:GTK_WIDGET(gtk_toggle_tool_button_new ())];
...
{
	self = [super initWithGtkWidget:GTK_WIDGET(gtk_toggle_tool_button_new_from_stock ([stockId UTF8String]))];
