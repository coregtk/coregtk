...
#import "CGTKColorSelectionDialog.h"
...
{
	return GTK_COLOR_SELECTION_DIALOG([self WIDGET]);
}

-(CGTKWidget *)getColorSelection
{
	return [CGTKWidget widgetWithGtkWidget:gtk_color_selection_dialog_get_color_selection ([self COLOR_SELECTION_DIALOG])];
}
