...
-(id)init
{
	self = [super initWithGtkWidget:gtk_button_new ()];
...
{
	self = [super initWithGtkWidget:gtk_button_new_with_label ([label UTF8String])];
...
{
	self = [super initWithGtkWidget:gtk_button_new_from_stock ([stockId UTF8String])];
...
{	
	self = [super initWithGtkWidget:gtk_button_new_with_mnemonic ([label UTF8String])];
